...
| `PEOPLE` | UserID, Email, Name, Role, LocationID, ApprovalLimit, Active |
...
ADMIN_EMAIL="<admin-email>"          ADMIN_PASSWORD="<set-in-local-env>"
PURCHASE_EMAIL="<purchase-email>"    PURCHASE_PASSWORD="<set-in-local-env>"
DISTRIBUTOR_EMAIL="<distributor-email>" DISTRIBUTOR_PASSWORD="<set-in-local-env>"
